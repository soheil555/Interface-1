...
export interface MasterChefInterface extends utils.Interface {
  functions: {
    ...
    "pendingAXO(uint256,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "pendingAXO", data: BytesLike): Result;
...
export interface MasterChef extends BaseContract {
  ...
  functions: {
    ...
    axoPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    axoPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
