...
import newup from "../../assets/images/newup.svg";
import newupActive from "../../assets/images/newup-active.svg";
                ...
                <ul className="nav nav-tabs">
                  <li className="nav-item">
                    ...
                    >
                      <h4>
                        Governance Forum{" "}
                        <img src={newup} alt="" className="nrmimg" />
                        <img src={newupActive} alt="" className="nrm-act" />
                      </h4>
                      <p>
                        The Tri Protocol is managed by a global community of TRI
                        token holders and delegates.
                  ...
                  <li className="nav-item">
                    <a className="nav-link" data-bs-toggle="tab" href="#menu1">
                      <h4>
                        Sybil <img src={newup} alt="" className="nrmimg" />
                        <img src={newupActive} alt="" className="nrm-act" />
                      </h4>
                      <p>
                        The Tri Protocol is managed by a global community of TRI
